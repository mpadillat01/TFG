  ...
  final List<Map<String, dynamic>> _productos = [
    {
      ...
      "precio": 14.99,
      "imagen":
          "https://png.pngtree.com/png-clipart/20230915/original/pngtree-pampering-your-feet-essential-foot-care-and-pedicure-tools-vector-png-image_12217580.png",
    },
    {
    ...
    return Scaffold(
      ...
      body: GridView.builder(
        ...
        itemBuilder: (context, i) {
          ...
          final enCarrito = _carrito.contains(i);
